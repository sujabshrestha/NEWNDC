...
class CreateSitevisitDocumentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sitevisit_documents', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sitevisit_documents');
    }
}
