...
class PaperworkerClientController extends Controller
{
    public $response;
    public $client;
    ...
    public function index(){
        try{
            return view('Paperworker::client.index');
    ...
    public function create(){
        try{
            return view('Paperworker::client.create');
        }catch(Exception $e){
            Toastr::error($e->getMessage());
            return redirect()->back();
        }
    ...
    public function store(Request $request ){
        try {
            ...
            if($client == true) {
                ...
                return redirect()->route('paperworker.client.create');
            }
    ...
    public function edit($id){
        try{
            ...
            return view('Paperworker::client.edit',compact('client'));
        }catch(Exception $e){
            Toastr::error($e->getMessage());
            return redirect()->back();
        }
    ...
    public function show($id){
        // try{
            ...
            return view('Paperworker::client.show',compact('client'));
        // }catch(Exception $e){
        //     Toastr::error($e->getMessage());
        //     return redirect()->back();
        // }
    ...
    public function update(Request $request, $id){
        // try {
            ...
            if ($user == true) {
                ...
                return redirect()->route('paperworker.client.index');
            }
            Toastr::error("Something Went Wrong");
            return redirect()->back();
        // } catch (Exception $e) {
    ...
    public function trashedIndex(){
        return view('Paperworker::user.trashedIndex');
    }
                    ...
                    <div class="action-dropdown custom-dropdown-icon">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" id="actionButton" aria-labelledby="dropdownMenuLink-2" style="will-change: transform; min-width:6rem !important;">
                                <a class="dropdown-item" href="'. route('paperworker.client.edit',$row->id) .'"><span class="text-primary">Edit</span></a>
                                <a class="important dropdown-item" href="'. route('paperworker.client.show',$row->id) .'"><span class="text-secondary">View</span></a>
                                <a class="dropdown-item deleteClient" href="javascript:void(0);" data-id="'. route('paperworker.client.destroy',$row->id) .'"><span class="text-danger">Delete</span></a>
                            </div>
                        </div>
                    </div>';
                    return $actionBtn;
