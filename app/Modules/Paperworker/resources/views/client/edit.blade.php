            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="col-12">
                        ...
                        <a class="btn btn-secondary float-right " href="{{ route('paperworker.client.index')}}">Previous Page</a>
                    </div>
                    <hr>
                    <div class="col-xl-12 col-md-12 col-sm-12">
                        <form action="{{ route('paperworker.client.update',$client->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            {{-- <input type="hidden" class="form-control" id="updateid" value="{{ $client->id }}"> --}}
                            @include('Paperworker::client.commonForm')
                            <div class="row">
                                <div class="col-12">
