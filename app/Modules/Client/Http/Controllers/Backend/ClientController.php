...
namespace Client\Http\Controllers\Backend;
...
class ClientController extends Controller
{
    ...
    public function create(){
        try{
            return view('Client::backend.client.create');
        }catch(Exception $e){
            Toastr::error($e->getMessage());
            return redirect()->back();
        }
    ...
    public function trashedIndex(){
        return view('Client::backend.user.trashedIndex');
    }
                    ...
                    <div class="action-dropdown custom-dropdown-icon">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" id="actionButton" aria-labelledby="dropdownMenuLink-2" style="will-change: transform; min-width:6rem !important;">
                                <a class="dropdown-item" href="'. route('client.edit',$row->id) .'"><span class="text-primary">Edit</span></a>
                                <a class="important dropdown-item" href="'. route('client.show',$row->id) .'"><span class="text-secondary">View</span></a>
                                <a class="dropdown-item deleteClient" href="javascript:void(0);" data-id="'. route('client.destroy',$row->id) .'"><span class="text-danger">Delete</span></a>
                            </div>
                        </div>
                    </div>';
                    return $actionBtn;
