                    ...
                    <form action="{{ route('receptionist.valuation.valuationFinalSubmit', $sitevisit->id) }}"
                        ...
                        <div class="row">
                            ...
                            <div id="BuildingArea" class="col-md-12 mt-2"
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="form-group col-md-1" style="flex: 5%;max-width: 5%; padding-right:0px;">
                                        <label style="width: 100%;">&nbsp;</label>
                                        <button type="button"
                                            data-url="{{ route('receptionist.valuation.buildingValautionSubmit', $sitevisit->id) }}"
                            ...
                            <div class="form-group col-md-2 pl-0">
                                <label style="width: 100%;">&nbsp;</label>
                                <button type="button" class="btn btn-info"
                                    data-url="{{ route('receptionist.valuation.govBoundarySubmit', $sitevisit->id) }}"
                            ...
                            <div class="form-group col-md-2 pl-0">
                                <label style="width:100%">&nbsp;</label>
                                <button type="button" class="btn btn-info"
                                    data-url="{{ route('receptionist.valuation.siteVisitBoundarySubmit', $sitevisit->id) }}"
                                    id="BtnAddBoundariesAsPerSiteVisit" style="padding: 2px 5px;">ADD</button>
                            </div>
                            <div class="form-group col-md-12">
                                <div class="appendSiteVisitData">
                                    @include('Receptionist::receptionist.valuations.appendsitevisitBoundaryData')
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                @include('Receptionist::receptionist.valuations.appendCADDocument')
                            </div>
