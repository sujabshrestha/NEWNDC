...
class ReceptionistBranchController extends Controller
{
   /**
        ...
        try{
            ...
            if ($request->ajax()) {
                ...
                ->addColumn('action', function ($row) {
                    $actionBtn = '<a href="javascript:void(0)" data-url="'.route('receptionist.branch.edit', $row->id).'" data-id=' . $row->id . ' class="edit btn btn-info btn-sm" title="Edit"><i class="far fa-edit"></i></a>
            ...
            $banks = Bank::all();
            return view('Receptionist::receptionist.branch.index', compact('banks'));
        }catch(\Exception $e){
    ...
    public function edit($id)
    {
        try{
            ...
            if($branch){
                $data = [
                    'view' => view('Receptionist::receptionist.branch.edit', compact('branch', 'banks'))->render()
                ];
