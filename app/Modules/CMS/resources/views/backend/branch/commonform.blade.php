<div class="col-md-12">
    <div class="form-group">
        ...
        <input type="text" name="title" value="{{ $branch->title ?? '' }}" id="title" class="form-control"
            placeholder="Title">
        @if ($errors->has('title'))
    ...
    <div class="form-group">
        ...
        <input type="text" name="location" value="{{ $branch->location ?? '' }}" id="location" class="form-control" placeholder="Location">
