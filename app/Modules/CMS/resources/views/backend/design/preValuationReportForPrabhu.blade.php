  ...
  @font-face {
    ...
    <div class="row">
      <div class="col-md-12" style="margin-top: 5px;">
        <b style="text-transform:uppercase;">NEPAL BANK LTD.</b>
        <br>
        Chabahil Branch    </div>
      ...
      <div class="col-md-12">
        <table class="table table-borderless mb-0">
          <tbody><tr>
            ...
            <td class="B U">Name : Mrs. Uma Kumari Shrestha</td>
          </tr>
                  <tr>
            <td></td>
            <td width="30"></td>
      ...
      <div class="col-md-12">
        <table class="table table-borderless mt-0">
          <tbody><tr>
            ...
            <td><strong>12,00,000.00</strong></td>
          ...
          <tr>
            ...
            <td style="border-bottom:1px solid #000;">12,95,600.00</td>
          ...
          <tr>
            ...
            <td style="border-bottom:1px solid #000;">2,97,306.00</td>
            <td><strong>&nbsp;&nbsp;&nbsp;Distress Value</strong></td>
            <td style="border-bottom:1px solid #000;">2,97,306.00</td>
