            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        <h1 class="">Register In to <a href="{{ route('backend.auth.register') }}"><span class="brand-name">EGP Nepal</span></a></h1>
                        {{-- {{ route('admin.user.register') }} --}}
                        <p class="signup-link">New Here? <a href="{{ route('backend.auth.login') }}">Already have an account?</a></p>

                        <form class="text-left" method="POST" action="{{ route('backend.auth.registersubmit') }}" enctype="multipart/form-data">
                            @csrf
