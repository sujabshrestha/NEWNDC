            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        <h1 class="">Log In to <a href="{{route('backend.auth.login')}}"><span class="brand-name">NDC</span></a></h1>
                        {{-- <p class="signup-link">New Here? <a href="auth_register.html">Create an account</a></p> --}}
                        <form  method="POST" action="{{ route('backend.auth.loginSubmit') }}" class="text-left">
                            @csrf
                            <div class="form">
                                ...
                                <div class="field-wrapper">
                                    <a href="{{ route('backend.auth.forgetPassword') }}" class="forgot-pass-link">Forgot Password?</a>
                                </div>
