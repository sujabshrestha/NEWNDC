        ...
        <select class="form-control selectbox" readonly name="branch_id" id="branchId" required="">
            ...
            @if (isset($branches))
                @foreach ($branches as $branch)
                    <option @if (
                        (isset($sitevisit) && $sitevisit->branch_id == $branch->id) ||
                            (isset($proposal) && $proposal->branch_id == $branch->id)) selected readonly @endif value="{{ $branch->id }}">
                        {{ $branch->title }}</option>
                @endforeach
            @endif
        </select>
        ...
        <select class="form-control selectbox" readonly name="site_engineer" id="TxtSiteEngineerId" required="">
            ...
            @if (isset($siteengineers))
                @foreach ($siteengineers as $user)
                    <option @if (
                        (isset($sitevisit) && $sitevisit->site_engineer_id == $user->id) ||
                            (isset($proposal) && $proposal->site_engineer == $user->id)) selected @endif value="{{ $user->id }}">
                        {{ $user->name }}</option>
                @endforeach
            @endif
        ...
        <select name="client_id" readonly class="form-control" id="">
            ...
            @if (isset($clients))
                @foreach ($clients as $client)
                    <option @if (
                        (isset($sitevisit) && $sitevisit->client_id == $client->id) ||
                            (isset($proposal) && $proposal->client_id == $client->id)) selected @endif value="{{ $client->id }}">
